...
def pipeline_with_logprob(
    ...
    self.check_inputs(input_imgs, height, width, callback_steps, negative_prompt, prompt_embeds, negative_prompt_embeds)
    ...
    # 3. Encode input prompt  TODO encode image with pose. Does this include the cc_projection layer already?
    text_encoder_lora_scale = cross_attention_kwargs.get("scale", None) if cross_attention_kwargs is not None else None
    # TODO encode with LORA enabled
    ...
    # 5. Prepare latent variables  TODO stopped here, moved to pipeline_zero1to3_with_logprob.py
    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            # No need to concat conditioned image here
